...
.searchTable tr:nth-child(odd){ background-color:#aad4ff; }
...
.logTable tr:nth-child(odd){ background-color:#007fff; }
...
.downloadbutton {
   border-top: 1px solid #96d1f8;
   background: #54590e;
   background: -webkit-gradient(linear, left top, left bottom, from(#ffbb00), to(#54590e));
   background: -webkit-linear-gradient(top, #ffbb00, #54590e);
   background: -moz-linear-gradient(top, #ffbb00, #54590e);
   background: -ms-linear-gradient(top, #ffbb00, #54590e);
   background: -o-linear-gradient(top, #ffbb00, #54590e);
   padding: 6px 12px;
...
.searchResult {
	...
	height:100%;
	margin:0px;padding:0px;
}.searchResult tr:last-child td:last-child {
	-moz-border-radius-bottomright:7px;
	-webkit-border-bottom-right-radius:7px;
	border-bottom-right-radius:7px;
}
.searchResult table tr:first-child td:first-child {
	-moz-border-radius-topleft:7px;
	-webkit-border-top-left-radius:7px;
	border-top-left-radius:7px;
}
.searchResult table tr:first-child td:last-child {
	-moz-border-radius-topright:7px;
	-webkit-border-top-right-radius:7px;
	border-top-right-radius:7px;
}.searchResult tr:last-child td:first-child{
	-moz-border-radius-bottomleft:7px;
	-webkit-border-bottom-left-radius:7px;
	border-bottom-left-radius:7px;
...
.searchResult tr:nth-child(odd){ background-color:#d4ffaa; }
.searchResult tr:nth-child(even)    { background-color:#ffffff; }.searchResult td{
	vertical-align:middle;
...
.searchResult tr:first-child:hover td{
	background:-o-linear-gradient(bottom, #5fbf00 5%, #3f7f00 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #5fbf00), color-stop(1, #3f7f00) );
	background:-moz-linear-gradient( center top, #5fbf00 5%, #3f7f00 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#5fbf00", endColorstr="#3f7f00");	background: -o-linear-gradient(top,#5fbf00,3f7f00);
...
.searchResult tr:first-child td:first-child{
	border-width:0px 0px 1px 0px;
}
.searchResult tr:first-child td:last-child{
	border-width:0px 0px 1px 1px;
}
